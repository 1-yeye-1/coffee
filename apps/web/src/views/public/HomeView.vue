...
<template>
  <div ref="homeRef" class="home-view" :class="{ 'home-css-ready': homeCssReady }">
    <section class="hero">
...
.home-css-ready .hero__stagger {
  animation: heroFadeUp var(--cb-duration-moderate) var(--cb-ease-emphasized) both;
}
.home-css-ready .hero__stagger:nth-child(1) { animation-delay: 0s; }
.home-css-ready .hero__stagger:nth-child(2) { animation-delay: .06s; }
.home-css-ready .hero__stagger:nth-child(3) { animation-delay: .12s; }
.home-css-ready .hero__stagger:nth-child(4) { animation-delay: .18s; }
.home-css-ready .hero__stagger:nth-child(5) { animation-delay: .24s; }
