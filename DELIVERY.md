...
详细说明见 [`docs/数据库设计说明.md`](docs/数据库设计说明.md)。

## 4. 接口说明概览

接口按模块划分：认证、用户、商品、图书、活动、社区、评论、预约、消息、积分优惠券、后台管理、上传。详细接口见 [`docs/接口文档.md`](docs/接口文档.md)。
...
测试说明见 [`docs/测试说明.md`](docs/测试说明.md)，安全审计与自动化安全 smoke 结果见 [`docs/安全测试报告.md`](docs/安全测试报告.md)。
