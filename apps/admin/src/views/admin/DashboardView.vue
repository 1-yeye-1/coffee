...
<template>
  <div class="admin-page">
    ...
    <section class="admin-dashboard-grid">
      <div class="admin-chart"><div class="admin-panel__header"><h2>近 7 日订单趋势</h2><BaseBadge variant="info">Orders</BaseBadge></div><div class="admin-bars"><div v-for="(value, index) in orderTrend" :key="value + index" class="admin-bar"><span :style="{ height: `${value / maxOrders * 100}%` }" /><small>{{ index + 1 }}日</small></div></div></div>
