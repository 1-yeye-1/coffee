...
- `README.md`：项目入口文档。
- `DELIVERY.md`：最终交付说明。
- `docs/`：接口、数据库、架构、测试、演示、安全报告、前后台闭环回归清单等补充文档。
...
- `scripts/security-smoke.js`：认证、越权、上传、路径穿越、安全头、业务风控等安全 smoke 测试。
